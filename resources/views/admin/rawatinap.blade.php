            ...
            <table class="table table-striped table-bordered ">
                ...
                @forelse($data as $key => $d)
                    <tr>
                        ...
                        <td width="50">
                            <a class="btn btn-sm btn-warning" id="detailData" data-id="{{$d->id}}" href="/admin/rawatinap/{{$d->id}}">Detail</a>
                            <a class="btn btn-sm btn-primary" id="editData" data-id="{{$d->id}}" data-penerimaan="{{$d->penerimaan}}" data-diagnosa="{{$d->diagnosa_awal}}" data-hubpenanggungjawab="{{$d->hubungan_penanggung_jawab}}" data-penanggungjawab="{{$d->penanggung_jawab}}" data-tanggal="{{$d->tanggal_masuk}}" data-kamar="{{$d->kamar->id}}" data-pasien="{{$d->pasien->id}}">Edit</a>
                            <a class="btn btn-sm btn-danger" id="deleteData" data-id="{{$d->id}}" onclick="hapus('{{$d->id}}','{{$d->no_reg}}')">Hapus</a>
                        </td>
                    </tr>
                @empty
                    <tr>
                    ...
                    <div class="modal-body">
                        <form id="form" onsubmit="return save()">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" id="hubpenanggungjawab" name="hubungan_penanggung_jawab">
                            </div>
