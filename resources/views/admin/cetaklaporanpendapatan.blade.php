    ...
    <div>
        <table style="border: none">
            <tr>
                ...
                <td>
                    <div>
                        <h4 style=" text-align: center;margin-bottom:0;margin-top:0; font-size: 1.2rem">KLINIK MUTIARA
                            ASRI
                        </h4>
                        <h5 style=" text-align: center;margin-bottom:0;margin-top:0; font-size: .8rem">Laporan Rawat
                            Inap
                        </h5>
                        <h5 style=" text-align: center;margin-bottom:0;margin-top:0; font-size: .8rem">Periode
                            @if ($start)
                                <span>{{ date('d F Y', strtotime($start)) }} -
                                    {{ date('d F Y', strtotime($end)) }}</span>
                            @else
                                <span>Semua</span>
                            @endif
                        </h5>
